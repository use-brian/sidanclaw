...
export function PresentationPresenter({ snapshot, onClose }: { snapshot: PresentationSnapshot; onClose(): void }) {
  ...
  return (
    <div ref={presenterRef} tabIndex={-1} data-office-presenter="true" data-reduced-motion={reducedMotion ? "true" : "false"} role="dialog" aria-modal="true" aria-label={t.presentationPreview} onPointerMove={pointerMove} onPointerDown={showControls} className="fixed inset-0 z-[100] flex bg-black text-white outline-none">
