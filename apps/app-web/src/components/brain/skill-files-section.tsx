  ...
  return (
    <div className="pb-4">
      <div className="flex flex-wrap items-end gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <input
            ...
            className="mt-1.5 h-9 w-full rounded-md border border-border bg-background px-3 font-mono text-[16px] md:text-xs text-foreground outline-none placeholder:text-muted-foreground"
          />
        </div>
      </div>
      <div className="mt-3">
      ...
      <textarea
        ...
        className="mt-3 w-full resize-y rounded-md border border-border bg-background px-3 py-2 font-mono text-[16px] md:text-xs leading-relaxed text-foreground outline-none placeholder:text-muted-foreground"
      />
